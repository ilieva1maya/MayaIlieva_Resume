            ...
            <article class="experience-item">
                ...
                <div class="program">
                    ...
                    <ul>
                        ...
                        <li>Collaborated with peers on group assignments to develop teamwork and communication skills.</li>
                    </ul>
                </div>
                ...
                <div class="program">
                    ...
                    <ul>
                        ...
                        <li>Gained understanding of responsive design principles and implemented them in projects.</li>
                    </ul>
                </div>
            </article>
            ...
            <article class="experience-item">
                ...
                <div class="program">
                    ...
                    <ul>
                        ...
                        <li>Developed modular components and data services to perform full CRUD functionality.</li>
                        <li>Implemented routing and navigation.</li>
                        <li>Implemented form handling and validation to ensure data integrity.</li>
                    </ul>
                </div>
                ...
                <div class="program">
                    ...
                    <ul>
                        ...
                        <li>Implemented reusable components and state management using React Hooks and context for efficient data updates.</li>
                        <li>Implemented routing and navigation using React Router to create multi-page experiences.</li>
                ...
                <div class="program">
                    ...
                    <ul>
                        ...
                        <li>Worked with databases such as MongoDB to store and retrieve data.</li>
                        <li>Write and execute unit tests using Mocha and Chai to ensure code reliability and maintainability.</li>
                    </ul>
                </div>
                ...
                <div class="program">
                    ...
                    <ul>
                        ...
                        <li>Gained foundational knowledge of web development principles and best practices.</li>
                        <li>Gained hands-on experience with DOM manipulation and event handling to create interactive web pages.</li>
                    </ul>
                </div>
            </article>
